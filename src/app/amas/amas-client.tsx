...
export default function AMAsClient({ 
  initialPosts, 
  topicCounts,
  blockchainTopics,
  subtopics
  ...
  return (
    <Suspense fallback={<div className="my-8 text-center">Loading AMAs...</div>}>
      <AMAsClientContent 
